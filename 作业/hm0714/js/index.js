...
// 完成顶部导航栏,用hover挺好的，嗯嗯
// var topNav = function () {
//     var lis = document.querySelectorAll(".nav_top>li");
//     var lis_l=lis.length;
//     var ul = document.getElementsByClassName("nav_top");
//     // 现在激活的div的index
//     var now = -1;
//     //
//     // 这个还是用循环添加事件吧，不装逼了
...
//             var t= e.target.parentNode.lastChild;
//             console.log(t);
//            if(t.nodeName==="DIV"){
